"""
=============================================================================
openmc_beavrs_vver1000_FIXED.py  —  High-Fidelity Generator for cnn_v9 / qica_v9-final
=============================================================================
...
# ── FIX 2 — shared boron convention (used by BOTH training gen and quick_check) ──
BORON_PPM_DEFAULT = 800.0      # used when neither boron_search nor a custom ppm is given
BORON_LO_DEFAULT  = 200.0
BORON_HI_DEFAULT  = 3500.0     # FIX 4 — raised from 2500
